...
pub type DomTree = IndexMap<Block, DomTreeNode, BuildHasherDefault<FxHasher>>;
impl AnalysisResultT for DomTree {}

// Dominance frontier sets.
pub type DomFronts =
    IndexMap<Block, IndexSet<Block, BuildHasherDefault<FxHasher>>, BuildHasherDefault<FxHasher>>;
